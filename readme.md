...
This will create an executable jar file **telegram-bot-db-api.jar** within the _target_ maven folder. This can be started by executing the following command

    java -jar target/telegram-bot-db-api.jar
